...
struct BinaryTree
{
  ...
  private:
     ...
     * @param subRoot The current node in the recursion.
     * @return Values of the nodes of a binary tree in order.
     */
     ...
     * @param subRoot The current node in the recursion.
     * @return Flip tree over a vertical axis.
     */
     ...
     * @param subRoot The current node in the recursion.
     * @param path The current path from root to current node.
     * @param pathLen The length of current path.
     * @return All the possible paths from the root of the tree to any leaf node.
     */
     void printPaths(const Node* subRoot, T path[], int pathLen) const;

    /**
     * Private helper function for the public sumDistances function.
     * @param subRoot The current node in the recursion.
     * @param pathLen The length of current path.
     * @param sum The current sum of path distances.
     * @return Sum of the distances of all nodes to the root node
     */
     void sumDistances(const Node* subRoot, int pathLen, int& sum) const;
